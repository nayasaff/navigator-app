...
import { getColorCode, isEmpty, logError, translate } from 'utils';
                                        ...
                                        <View style={tailwind('flex-1')}>
                                            ...
                                            >
                                                <View style={tailwind('btn bg-gray-800 border border-gray-700 bg-opacity-75')}>
                                                    <Text style={tailwind('font-semibold text-gray-50 text-base')}>{translate("ProofScreen.reset")}</Text>
                                                </View>
                                            </TouchableOpacity>
                                        </View>
                                        <View style={tailwind('flex-1')}>
                                            ...
                                            >
                                                <View style={tailwind('btn bg-green-900 border border-green-700')}>
                                                    ...
                                                    <Text style={tailwind('font-semibold text-green-50 text-base')}>{translate("ProofScreen.capture")}</Text>
                                                </View>
                                            </TouchableOpacity>
                                        </View>
                                    </View>
                            ...
                            <View style={tailwind('px-4')}>
                                <View style={tailwind('border bg-blue-900 border border-blue-700 rounded-md shadow-lg mb-32')}>
                                    <View style={tailwind('px-3 py-2 border-b border-blue-700')}>
                                        <Text style={tailwind('font-semibold text-base text-blue-50')}>{translate("ProofScreen.focusTarget")}</Text>
                                    </View>
                                    <View style={tailwind('px-3 py-2')}>
                                        {isWaypoint && waypoint && (
                                            <View>
                                                <Text style={tailwind('font-bold text-white mb-1')}>{translate("ProofScreen.currentDestination")}</Text>
                                        ...
                                        {isEntity && (
                                            <View style={tailwind('flex flex-row py-2 px-3')}>
                                                ...
                                                <View>
                                                    ...
                                                    {translate("ProofScreen.tracking")} {entity.getAttribute('tracking_number.tracking_number')}
                                                    </Text>
                                                    {entity.isAttributeFilled('tracking_number.internal_id') && (
                                                        <Text style={tailwind('text-blue-50')} numberOfLines={1}>
                                                            {translate("ProofScreen.internalId")} {entity.getAttribute('tracking_number.internal_id')}
                                                        </Text>
                                                    )}
                                                    {entity.isAttributeFilled('tracking_number.sku') && (
                                                        <Text style={tailwind('text-blue-50')} numberOfLines={1}>
                                                            {translate("ProofScreen.sku")} {entity.getAttribute('tracking_number.sku')}
                                                        </Text>
                                                    )}
                                                </View>
                                            </View>
